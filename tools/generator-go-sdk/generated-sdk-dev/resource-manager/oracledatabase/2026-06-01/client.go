...
import (
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/oracledatabase/2026-06-01/autonomousdatabasebackups"
	"github.com/hashicorp/go-azure-sdk/resource-manager/oracledatabase/2026-06-01/autonomousdatabasecharactersets"
	"github.com/hashicorp/go-azure-sdk/resource-manager/oracledatabase/2026-06-01/autonomousdatabasenationalcharactersets"
	"github.com/hashicorp/go-azure-sdk/resource-manager/oracledatabase/2026-06-01/autonomousdatabases"
	"github.com/hashicorp/go-azure-sdk/resource-manager/oracledatabase/2026-06-01/autonomousdatabaseversions"
	"github.com/hashicorp/go-azure-sdk/resource-manager/oracledatabase/2026-06-01/cloudexadatainfrastructures"
	"github.com/hashicorp/go-azure-sdk/resource-manager/oracledatabase/2026-06-01/cloudvmclusters"
	"github.com/hashicorp/go-azure-sdk/resource-manager/oracledatabase/2026-06-01/databaseeditions"
	"github.com/hashicorp/go-azure-sdk/resource-manager/oracledatabase/2026-06-01/databasesystemshaperesources"
	"github.com/hashicorp/go-azure-sdk/resource-manager/oracledatabase/2026-06-01/dbnodes"
	"github.com/hashicorp/go-azure-sdk/resource-manager/oracledatabase/2026-06-01/dbservers"
	"github.com/hashicorp/go-azure-sdk/resource-manager/oracledatabase/2026-06-01/dbsystems"
	"github.com/hashicorp/go-azure-sdk/resource-manager/oracledatabase/2026-06-01/dbsystemshapes"
	"github.com/hashicorp/go-azure-sdk/resource-manager/oracledatabase/2026-06-01/dbversions"
	"github.com/hashicorp/go-azure-sdk/resource-manager/oracledatabase/2026-06-01/dnsprivateviews"
	"github.com/hashicorp/go-azure-sdk/resource-manager/oracledatabase/2026-06-01/dnsprivatezones"
	"github.com/hashicorp/go-azure-sdk/resource-manager/oracledatabase/2026-06-01/exadbvmclusters"
	"github.com/hashicorp/go-azure-sdk/resource-manager/oracledatabase/2026-06-01/exascaledbnodes"
	"github.com/hashicorp/go-azure-sdk/resource-manager/oracledatabase/2026-06-01/exascaledbstoragevaults"
	"github.com/hashicorp/go-azure-sdk/resource-manager/oracledatabase/2026-06-01/flexcomponents"
	"github.com/hashicorp/go-azure-sdk/resource-manager/oracledatabase/2026-06-01/giminorversions"
	"github.com/hashicorp/go-azure-sdk/resource-manager/oracledatabase/2026-06-01/giversions"
	"github.com/hashicorp/go-azure-sdk/resource-manager/oracledatabase/2026-06-01/goldengateconnections"
	"github.com/hashicorp/go-azure-sdk/resource-manager/oracledatabase/2026-06-01/goldengatedeployments"
	"github.com/hashicorp/go-azure-sdk/resource-manager/oracledatabase/2026-06-01/networkanchors"
	"github.com/hashicorp/go-azure-sdk/resource-manager/oracledatabase/2026-06-01/oraclesubscriptions"
	"github.com/hashicorp/go-azure-sdk/resource-manager/oracledatabase/2026-06-01/resourceanchors"
	"github.com/hashicorp/go-azure-sdk/resource-manager/oracledatabase/2026-06-01/systemversions"
	"github.com/hashicorp/go-azure-sdk/resource-manager/oracledatabase/2026-06-01/virtualnetworkaddresses"
...
type Client struct {
	...
	DatabaseEditions                        *databaseeditions.DatabaseEditionsClient
	DatabaseSystemShapeResources            *databasesystemshaperesources.DatabaseSystemShapeResourcesClient
	...
	GoldenGateConnections                   *goldengateconnections.GoldenGateConnectionsClient
	GoldenGateDeployments                   *goldengatedeployments.GoldenGateDeploymentsClient
...
func NewClientWithBaseURI(sdkApi sdkEnv.Api, configureFunc func(c *resourcemanager.Client)) (*Client, error) {
	...
	databaseEditionsClient, err := databaseeditions.NewDatabaseEditionsClientWithBaseURI(sdkApi)
	if err != nil {
		return nil, fmt.Errorf("building DatabaseEditions client: %+v", err)
	}
	configureFunc(databaseEditionsClient.Client)

	databaseSystemShapeResourcesClient, err := databasesystemshaperesources.NewDatabaseSystemShapeResourcesClientWithBaseURI(sdkApi)
	if err != nil {
		return nil, fmt.Errorf("building DatabaseSystemShapeResources client: %+v", err)
	}
	configureFunc(databaseSystemShapeResourcesClient.Client)
	...
	goldenGateConnectionsClient, err := goldengateconnections.NewGoldenGateConnectionsClientWithBaseURI(sdkApi)
	if err != nil {
		return nil, fmt.Errorf("building GoldenGateConnections client: %+v", err)
	}
	configureFunc(goldenGateConnectionsClient.Client)

	goldenGateDeploymentsClient, err := goldengatedeployments.NewGoldenGateDeploymentsClientWithBaseURI(sdkApi)
	if err != nil {
		return nil, fmt.Errorf("building GoldenGateDeployments client: %+v", err)
	}
	configureFunc(goldenGateDeploymentsClient.Client)
	...
	return &Client{
		...
		DatabaseEditions:                        databaseEditionsClient,
		DatabaseSystemShapeResources:            databaseSystemShapeResourcesClient,
		...
		GoldenGateConnections:                   goldenGateConnectionsClient,
		GoldenGateDeployments:                   goldenGateDeploymentsClient,
