...
type AutonomousDatabaseCrossRegionDisasterRecoveryProperties struct {
	...
	BackupDestination                        *BackupDestinationType                `json:"backupDestination,omitempty"`
	...
	IsScheduleAzUpdateToEarliest             *bool                                 `json:"isScheduleAzUpdateToEarliest,omitempty"`
	...
	TimeScheduledAzUpdate                    *string                               `json:"timeScheduledAzUpdate,omitempty"`
...
func (s AutonomousDatabaseCrossRegionDisasterRecoveryProperties) AutonomousDatabaseBaseProperties() BaseAutonomousDatabaseBasePropertiesImpl {
	return BaseAutonomousDatabaseBasePropertiesImpl{
		...
		BackupDestination:                        s.BackupDestination,
		...
		IsScheduleAzUpdateToEarliest:             s.IsScheduleAzUpdateToEarliest,
		...
		TimeScheduledAzUpdate:                    s.TimeScheduledAzUpdate,
