...
func PossibleValuesForGiMinorVersionSortOrder() []string {
	return []string{
		string(GiMinorVersionSortOrderASC),
		string(GiMinorVersionSortOrderDESC),
	}
}

func (s *GiMinorVersionSortOrder) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseGiMinorVersionSortOrder(decoded)
	if err != nil {
...
func parseGiMinorVersionSortOrder(input string) (*GiMinorVersionSortOrder, error) {
	vals := map[string]GiMinorVersionSortOrder{
		"asc":  GiMinorVersionSortOrderASC,
		"desc": GiMinorVersionSortOrderDESC,
	}
	...
	out := GiMinorVersionSortOrder(input)
	return &out, nil
}
