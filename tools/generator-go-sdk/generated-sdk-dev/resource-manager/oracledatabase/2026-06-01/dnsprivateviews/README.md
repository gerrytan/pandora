...
## `github.com/hashicorp/go-azure-sdk/resource-manager/oracledatabase/2026-06-01/dnsprivateviews` Documentation

The `dnsprivateviews` SDK allows for interaction with Azure Resource Manager `oracledatabase` (API Version `2026-06-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/oracledatabase/2026-06-01/dnsprivateviews"
```
