...
const (
	BaseDbSystemShapesVMPointBaseDBPointxEightSix   BaseDbSystemShapes = "VM.BaseDB.x86"
...
func PossibleValuesForBaseDbSystemShapes() []string {
	return []string{
		string(BaseDbSystemShapesVMPointBaseDBPointxEightSix),
...
func parseBaseDbSystemShapes(input string) (*BaseDbSystemShapes, error) {
	vals := map[string]BaseDbSystemShapes{
		"vm.basedb.x86":   BaseDbSystemShapesVMPointBaseDBPointxEightSix,
