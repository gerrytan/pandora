...
type CloudVMClusterProperties struct {
	...
	IsAcceleratedNetworkEnabled    *bool                                  `json:"isAcceleratedNetworkEnabled,omitempty"`
	...
	RecoStoragePercentage          *int64                                 `json:"recoStoragePercentage,omitempty"`
	...
	SparseStoragePercentage        *int64                                 `json:"sparseStoragePercentage,omitempty"`
